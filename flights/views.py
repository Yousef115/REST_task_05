...
from .serializers import (FlightSerializer, BookingSerializer, BookingDetailsSerializer, 
							UpdateBookingSerializer, UserUpdateBookingSerializer, RegisterSerializer)
